...
// ── Route table ────────────────────────────
// All 10 handleInternalApi endpoints as RouteDefs for the shared dispatcher:
// the deploy-gated restart-countdown plus the 9 Discord-bot-gated routes
// (including flaired-ids, added after the migration on BOTH arms per the
