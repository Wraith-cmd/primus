...
export const guideStrings = {
  ...
  abilityHook: {
    ...
    brain_freeze:
      'Your frost bolts sometimes make the next Winterlash instant and skip its cooldown.',
  ...
  worldPage: {
    heading: 'The world',
    intro:
      'PRIMUS is one continuous land you cross on foot, three zones laid south to north. There is no fast travel, so the journey is part of the adventure.',
    hub: 'Home base',
