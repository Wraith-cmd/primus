...
export const hudChromeStrings = {
  ...
  // The community Plugin Store window (src/ui/plugins/): browse, install,
  // and submit client-side mods reviewed by the team before listing.
  plugins: {
    title: 'Plugin Store',
    close: 'Close',
    tabBrowse: 'Browse',
    ...
    byAuthor: 'by {author}',
    byTeam: 'by the World of ClaudeCraft team',
    loading: 'Loading the plugin store...',
    offline: 'Sign in to an online realm to browse and install plugins.',
    empty: 'No plugins are listed yet. Be the first to publish one.',
    filteredOut: 'No plugins match your search.',
    installedEmpty: 'You have not installed any plugins yet.',
    developIntro:
      'Plugins are client-side mods. Every submission is reviewed by the team before it appears in the store, and updates are reviewed again before they reach players.',
    docsHint:
      'API: woc.on(event, handler) with combat, chat, loot, xp, levelup, quest, death, respawn, deed, and tick events, plus woc.player(), woc.ui.panel(), woc.ui.toast(), woc.ui.sound(), woc.storage, and woc.util formatters.',
    formName: 'Plugin name',
    formAuthor: 'Author name',
    formCategory: 'Category',
    formSummary: 'One-line summary',
    formDescription: 'Description',
    formSource: 'Plugin source (JavaScript)',
    formNotes: 'Note for the reviewer',
    submitNew: 'Submit for review',
    submitUpdate: 'Submit update for review',
    newPlugin: 'Start a new plugin instead',
    editPlugin: 'Update',
    deletePlugin: 'Retire',
    mineTitle: 'My plugins',
    statusPending: 'Awaiting review',
    statusApproved: 'Approved',
    statusRejected: 'Rejected',
    statusListed: 'Listed',
    statusDelisted: 'Delisted',
    latestLine: 'Latest submission v{version}: {status}',
    reviewNote: 'Reviewer note: {note}',
    submitted: 'Submitted for review. You can keep playing; the team will take a look.',
    autoDisabled: '{name} ran into repeated errors and was turned off.',
  },
};
