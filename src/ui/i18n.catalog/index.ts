...
export const en = {
  ...
  mode: {
    ...
    runDesc:
      'A twenty minute dungeon run, no leveling required. Pick a class and land at the door at the level cap, geared, with a tank, a healer and two damage dealers already hired.',
    runDungeon: 'Dungeon',
  ...
  playerCard: {
    ...
    arenaStat: 'Arena',
    shareText: "I'm forging my legend in PRIMUS: Level {level} {className}. Join my world:",
    nativeShareTitle: 'PRIMUS',
