...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'playerCard.shareText':
    'Je forge ma légende dans World of ClaudeCraft : niveau {level} {className}. Rejoignez mon monde :',
  ...
  'guide.abilityHook.brain_freeze':
    "Vos éclairs de givre rendent parfois le prochain Fouet de l'hiver instantané et ignorent son temps de recharge.",
