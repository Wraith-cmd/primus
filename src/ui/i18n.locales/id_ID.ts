...
export const id_ID: Partial<Record<TranslationKey, string>> = {
  ...
  'playerCard.shareText':
    'Aku sedang menempa legendaku di World of ClaudeCraft: Level {level} {className}. Bergabunglah dengan duniaku:',
  ...
  'guide.abilityHook.brain_freeze':
    'Panah es Anda terkadang membuat Cambuk Musim Dingin berikutnya menjadi instan dan melewatkan cooldownnya.',
