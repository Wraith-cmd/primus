...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'mode.runStart': '攻略を開始',
  'mode.runParty': 'あなたのパーティー：タンク、ヒーラー、ダメージ、ダメージ。',
  'mode.runDungeon': 'ダンジョン',
  'mode.runDesc': 'レベル上げ不要、20分のダンジョン攻略。クラスを選ぶだけで、最大レベル・装備済みで入口に到着し、タンク1人、ヒーラー1人、ダメージ2人がすでに雇われています。',
  'mode.runTitle': 'キーストーンラン',
  'mode.runAria': 'キーストーンラン：最大レベルでコンパニオンパーティーとダンジョンに入ります',
  'mode.runCta': 'キーストーンラン',
  'mode.offlineDesc':
