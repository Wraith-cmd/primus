...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.plugins.invalid_source': 'プラグインのソースが空です。',
  'apiError.plugins.source_too_large': 'プラグインのソースが大きすぎます。',
  'apiError.plugins.source_syntax': 'プラグインのソースに構文エラーがあります。',
  'apiError.plugins.limit_reached': 'このアカウントのプラグイン数が上限に達しました。',
  'apiError.plugins.install_limit': 'インストール済みプラグイン数が上限に達しました。',
  ...
  'hudChrome.plugins.title': 'プラグインストア',
  'hudChrome.plugins.close': '閉じる',
  'hudChrome.plugins.tabBrowse': 'ブラウズ',
  'hudChrome.plugins.tabInstalled': 'インストール済み',
  'hudChrome.plugins.tabDevelop': '開発',
  'hudChrome.plugins.searchPlaceholder': 'プラグインを検索',
  'hudChrome.plugins.catAll': 'すべてのカテゴリ',
  'hudChrome.plugins.catCombat': '戦闘',
  'hudChrome.plugins.catEconomy': '経済',
  'hudChrome.plugins.catSocial': 'ソーシャル',
  'hudChrome.plugins.catInterface': 'インターフェース',
  'hudChrome.plugins.catTools': 'ツール',
  'hudChrome.plugins.install': 'インストール',
  'hudChrome.plugins.uninstall': 'アンインストール',
  'hudChrome.plugins.enable': '有効にする',
  'hudChrome.plugins.disable': '無効にする',
  'hudChrome.plugins.viewSource': 'ソースを表示',
  'hudChrome.plugins.hideSource': 'ソースを隠す',
  'hudChrome.plugins.installs': '{count} インストール',
  ...
  'hudChrome.plugins.formSummary': '1行の概要',
  'hudChrome.plugins.formDescription': '説明',
  'hudChrome.plugins.formSource': 'プラグインソース (JavaScript)',
  'hudChrome.plugins.formNotes': '審査担当者へのメモ',
  'hudChrome.plugins.submitNew': '審査に提出',
  'hudChrome.plugins.submitUpdate': '更新を審査に提出',
  'hudChrome.plugins.newPlugin': '代わりに新しいプラグインを作成',
  'hudChrome.plugins.editPlugin': '更新',
  'hudChrome.plugins.deletePlugin': '引退させる',
  'hudChrome.plugins.mineTitle': 'マイプラグイン',
  'hudChrome.plugins.statusPending': '審査待ち',
  'hudChrome.plugins.statusApproved': '承認済み',
  'hudChrome.plugins.statusRejected': '却下',
  'hudChrome.plugins.statusListed': '掲載中',
  'hudChrome.plugins.statusDelisted': '掲載停止',
  'hudChrome.plugins.latestLine': '最新の提出 v{version}: {status}',
  'hudChrome.plugins.reviewNote': '審査メモ: {note}',
  'hudChrome.plugins.submitted': '審査に提出しました。プレイを続けてください。チームが確認します。',
  'hudChrome.plugins.autoDisabled': '{name} でエラーが繰り返されたため無効にしました。',
