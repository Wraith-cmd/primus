...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.plugins.source_syntax': '플러그인 소스에 구문 오류가 있습니다.',
  'apiError.plugins.limit_reached': '이 계정의 플러그인 한도에 도달했습니다.',
  'apiError.plugins.install_limit': '설치된 플러그인 한도에 도달했습니다.',
  ...
  'hudChrome.plugins.title': '플러그인 상점',
  'hudChrome.plugins.close': '닫기',
  'hudChrome.plugins.tabBrowse': '둘러보기',
  'hudChrome.plugins.tabInstalled': '설치됨',
  'hudChrome.plugins.tabDevelop': '개발',
  'hudChrome.plugins.searchPlaceholder': '플러그인 검색',
  'hudChrome.plugins.catAll': '모든 카테고리',
  'hudChrome.plugins.catCombat': '전투',
  'hudChrome.plugins.catEconomy': '경제',
  'hudChrome.plugins.catSocial': '소셜',
  'hudChrome.plugins.catInterface': '인터페이스',
  'hudChrome.plugins.catTools': '도구',
  'hudChrome.plugins.install': '설치',
  'hudChrome.plugins.uninstall': '제거',
  'hudChrome.plugins.enable': '켜기',
  'hudChrome.plugins.disable': '끄기',
  'hudChrome.plugins.viewSource': '소스 보기',
  'hudChrome.plugins.hideSource': '소스 숨기기',
  'hudChrome.plugins.installs': '설치 {count}회',
  'hudChrome.plugins.byAuthor': '제작: {author}',
  'hudChrome.plugins.byTeam': 'World of ClaudeCraft 팀 제작',
  'hudChrome.plugins.loading': '플러그인 상점을 불러오는 중...',
  'hudChrome.plugins.offline': '온라인 서버에 로그인하면 플러그인을 둘러보고 설치할 수 있습니다.',
  ...
  'hudChrome.plugins.formSummary': '한 줄 요약',
  'hudChrome.plugins.formDescription': '설명',
  'hudChrome.plugins.formSource': '플러그인 소스 (JavaScript)',
  'hudChrome.plugins.formNotes': '검토자에게 남길 메모',
  'hudChrome.plugins.submitNew': '검토 제출',
  'hudChrome.plugins.submitUpdate': '업데이트 검토 제출',
  'hudChrome.plugins.newPlugin': '대신 새 플러그인 시작',
  'hudChrome.plugins.editPlugin': '업데이트',
  'hudChrome.plugins.deletePlugin': '내리기',
  'hudChrome.plugins.mineTitle': '내 플러그인',
  'hudChrome.plugins.statusPending': '검토 대기 중',
  'hudChrome.plugins.statusApproved': '승인됨',
  'hudChrome.plugins.statusRejected': '거부됨',
  'hudChrome.plugins.statusListed': '등록됨',
  'hudChrome.plugins.statusDelisted': '내려감',
  'hudChrome.plugins.latestLine': '최근 제출 v{version}: {status}',
  'hudChrome.plugins.reviewNote': '검토 메모: {note}',
  'hudChrome.plugins.submitted': '검토를 위해 제출했습니다. 계속 플레이하세요. 팀이 곧 확인합니다.',
  'hudChrome.plugins.autoDisabled': '{name}에서 오류가 반복되어 꺼졌습니다.',
