...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'mode.runStart': 'Начать забег',
  'mode.runParty': 'Ваш отряд: танк, лекарь, боец, боец.',
  'mode.runDungeon': 'Подземелье',
  'mode.runDesc': 'Двадцатиминутный забег по подземелью без прокачки. Выберите класс и окажитесь у входа на максимальном уровне, в снаряжении, уже наняв танка, лекаря и двух бойцов.',
  'mode.runTitle': 'Ключевой забег',
  'mode.runAria': 'Ключевой забег: вход в подземелье на максимальном уровне с отрядом спутников',
  'mode.runCta': 'Ключевой забег',
  'mode.offlineDesc':
