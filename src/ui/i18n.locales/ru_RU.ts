...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.plugins.source_syntax': 'В исходном коде плагина синтаксическая ошибка.',
  'apiError.plugins.limit_reached': 'Достигнут лимит плагинов для этого аккаунта.',
  'apiError.plugins.install_limit': 'Достигнут лимит установленных плагинов.',
  ...
  'hudChrome.plugins.title': 'Магазин плагинов',
  'hudChrome.plugins.close': 'Закрыть',
  'hudChrome.plugins.tabBrowse': 'Обзор',
  'hudChrome.plugins.tabInstalled': 'Установленные',
  'hudChrome.plugins.tabDevelop': 'Разработка',
  'hudChrome.plugins.searchPlaceholder': 'Поиск плагинов',
  'hudChrome.plugins.catAll': 'Все категории',
  'hudChrome.plugins.catCombat': 'Бой',
  'hudChrome.plugins.catEconomy': 'Экономика',
  'hudChrome.plugins.catSocial': 'Социальное',
  'hudChrome.plugins.catInterface': 'Интерфейс',
  'hudChrome.plugins.catTools': 'Инструменты',
  'hudChrome.plugins.install': 'Установить',
  'hudChrome.plugins.uninstall': 'Удалить',
  'hudChrome.plugins.enable': 'Включить',
  'hudChrome.plugins.disable': 'Отключить',
  'hudChrome.plugins.viewSource': 'Показать код',
  'hudChrome.plugins.hideSource': 'Скрыть код',
  'hudChrome.plugins.installs': 'Установок: {count}',
  'hudChrome.plugins.byAuthor': 'Автор: {author}',
  'hudChrome.plugins.byTeam': 'От команды World of ClaudeCraft',
  'hudChrome.plugins.loading': 'Загрузка магазина плагинов...',
  'hudChrome.plugins.offline': 'Войдите в онлайн-мир, чтобы просматривать и устанавливать плагины.',
  ...
  'hudChrome.plugins.formSummary': 'Краткое описание',
  'hudChrome.plugins.formDescription': 'Описание',
  'hudChrome.plugins.formSource': 'Исходный код плагина (JavaScript)',
  'hudChrome.plugins.formNotes': 'Заметка для проверяющего',
  'hudChrome.plugins.submitNew': 'Отправить на проверку',
  'hudChrome.plugins.submitUpdate': 'Отправить обновление на проверку',
  'hudChrome.plugins.newPlugin': 'Создать новый плагин',
  'hudChrome.plugins.editPlugin': 'Обновить',
  'hudChrome.plugins.deletePlugin': 'Снять',
  'hudChrome.plugins.mineTitle': 'Мои плагины',
  'hudChrome.plugins.statusPending': 'Ожидает проверки',
  'hudChrome.plugins.statusApproved': 'Одобрено',
  'hudChrome.plugins.statusRejected': 'Отклонено',
  'hudChrome.plugins.statusListed': 'В каталоге',
