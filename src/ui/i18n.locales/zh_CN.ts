...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.plugins.invalid_name': '插件名称需为3到40个字母、数字、空格、撇号或连字符。',
  'apiError.plugins.name_not_allowed': '该插件名称不被允许。',
  'apiError.plugins.invalid_handle': '作者名需为2到24个字母、数字、空格、撇号或连字符。',
  'apiError.plugins.invalid_summary': '简介必须为一行, 最多140个字符。',
  'apiError.plugins.invalid_description': '描述过长或包含不支持的字符。',
  'apiError.plugins.invalid_category': '请选择列出的分类之一。',
  'apiError.plugins.invalid_source': '插件源码为空。',
  'apiError.plugins.source_too_large': '插件源码过大。',
  'apiError.plugins.source_syntax': '插件源码存在语法错误。',
  'apiError.plugins.limit_reached': '该账号的插件数量已达上限。',
  'apiError.plugins.install_limit': '已安装插件数量已达上限。',
  'apiError.plugins.not_found': '未找到插件。',
  'apiError.plugins.not_listed': '该插件当前不可用。',
  'apiError.plugins.not_installed': '该插件尚未安装。',
  'apiError.plugins.slug_unavailable': '无法为该插件保留链接名。请尝试其他名称。',
  'apiError.plugins.review_invalid': '该审核操作无效。',
  ...
  'hudChrome.plugins.title': '插件商店',
  'hudChrome.plugins.close': '关闭',
  'hudChrome.plugins.tabBrowse': '浏览',
  'hudChrome.plugins.tabInstalled': '已安装',
  'hudChrome.plugins.tabDevelop': '开发',
  'hudChrome.plugins.searchPlaceholder': '搜索插件',
  'hudChrome.plugins.catAll': '全部分类',
  'hudChrome.plugins.catCombat': '战斗',
  'hudChrome.plugins.catEconomy': '经济',
  'hudChrome.plugins.catSocial': '社交',
  'hudChrome.plugins.catInterface': '界面',
  'hudChrome.plugins.catTools': '工具',
  'hudChrome.plugins.install': '安装',
  'hudChrome.plugins.uninstall': '卸载',
  'hudChrome.plugins.enable': '启用',
  'hudChrome.plugins.disable': '停用',
  'hudChrome.plugins.viewSource': '查看源码',
  'hudChrome.plugins.hideSource': '隐藏源码',
  'hudChrome.plugins.installs': '{count} 次安装',
  'hudChrome.plugins.byAuthor': '作者: {author}',
  'hudChrome.plugins.byTeam': '由 World of ClaudeCraft 团队制作',
  'hudChrome.plugins.loading': '正在加载插件商店...',
  'hudChrome.plugins.offline': '登录在线服务器后即可浏览和安装插件。',
  ...
  'hudChrome.plugins.formSummary': '一句话简介',
  'hudChrome.plugins.formDescription': '描述',
  'hudChrome.plugins.formSource': '插件源码 (JavaScript)',
  'hudChrome.plugins.formNotes': '给审核者的备注',
  'hudChrome.plugins.submitNew': '提交审核',
  'hudChrome.plugins.submitUpdate': '提交更新审核',
  'hudChrome.plugins.newPlugin': '改为创建新插件',
  'hudChrome.plugins.editPlugin': '更新',
  'hudChrome.plugins.deletePlugin': '下架',
  'hudChrome.plugins.mineTitle': '我的插件',
  'hudChrome.plugins.statusPending': '等待审核',
  'hudChrome.plugins.statusApproved': '已通过',
  'hudChrome.plugins.statusRejected': '已驳回',
  'hudChrome.plugins.statusListed': '已上架',
  'hudChrome.plugins.statusDelisted': '已下架',
  'hudChrome.plugins.latestLine': '最新提交 v{version}: {status}',
  'hudChrome.plugins.reviewNote': '审核备注: {note}',
  'hudChrome.plugins.submitted': '已提交审核。你可以继续游戏, 团队会尽快查看。',
  'hudChrome.plugins.autoDisabled': '{name} 反复出错, 已被关闭。',
