...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.shiftMode': '静音模式（静音并限制帧率）',
  ...
  'mode.runStart': '开始挑战',
  'mode.runParty': '你的小队：坦克、治疗、输出、输出。',
  'mode.runDungeon': '地下城',
  'mode.runDesc': '一场二十分钟的地下城挑战，无需升级。选择一个职业，直接以满级、带齐装备抵达门口，并已雇好一名坦克、一名治疗和两名输出。',
  'mode.runTitle': '基石副本',
  'mode.runAria': '基石副本：以满级角色带领随从小队进入地下城',
  'mode.runCta': '基石副本',
  ...
  'playerCard.shareText':
    '我正在 World of ClaudeCraft 中铸就传说：{level}级 {className}。加入我的世界：',
