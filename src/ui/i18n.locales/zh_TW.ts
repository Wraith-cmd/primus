...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.plugins.invalid_name': '外掛名稱需為3到40個字母、數字、空格、撇號或連字號。',
  'apiError.plugins.name_not_allowed': '該外掛名稱不被允許。',
  'apiError.plugins.invalid_handle': '作者名需為2到24個字母、數字、空格、撇號或連字號。',
  'apiError.plugins.invalid_summary': '簡介必須為一行, 最多140個字元。',
  'apiError.plugins.invalid_description': '描述過長或包含不支援的字元。',
  'apiError.plugins.invalid_category': '請選擇列出的分類之一。',
  'apiError.plugins.invalid_source': '外掛原始碼為空。',
  'apiError.plugins.source_too_large': '外掛原始碼過大。',
  'apiError.plugins.source_syntax': '外掛原始碼有語法錯誤。',
  'apiError.plugins.limit_reached': '此帳號的外掛數量已達上限。',
  'apiError.plugins.install_limit': '已安裝外掛數量已達上限。',
  'apiError.plugins.not_found': '找不到外掛。',
  'apiError.plugins.not_listed': '該外掛目前不可用。',
  'apiError.plugins.not_installed': '該外掛尚未安裝。',
  'apiError.plugins.slug_unavailable': '無法為該外掛保留連結名稱。請嘗試其他名稱。',
  'apiError.plugins.review_invalid': '該審核操作無效。',
  ...
  'hudChrome.plugins.title': '外掛商店',
  'hudChrome.plugins.close': '關閉',
  'hudChrome.plugins.tabBrowse': '瀏覽',
  'hudChrome.plugins.tabInstalled': '已安裝',
  'hudChrome.plugins.tabDevelop': '開發',
  'hudChrome.plugins.searchPlaceholder': '搜尋外掛',
  'hudChrome.plugins.catAll': '全部分類',
  'hudChrome.plugins.catCombat': '戰鬥',
  'hudChrome.plugins.catEconomy': '經濟',
  'hudChrome.plugins.catSocial': '社交',
  'hudChrome.plugins.catInterface': '介面',
  'hudChrome.plugins.catTools': '工具',
  'hudChrome.plugins.install': '安裝',
  'hudChrome.plugins.uninstall': '解除安裝',
  'hudChrome.plugins.enable': '啟用',
  'hudChrome.plugins.disable': '停用',
  'hudChrome.plugins.viewSource': '檢視原始碼',
  'hudChrome.plugins.hideSource': '隱藏原始碼',
  'hudChrome.plugins.installs': '{count} 次安裝',
  'hudChrome.plugins.byAuthor': '作者: {author}',
  'hudChrome.plugins.byTeam': '由 World of ClaudeCraft 團隊製作',
  'hudChrome.plugins.loading': '正在載入外掛商店...',
  'hudChrome.plugins.offline': '登入線上伺服器後即可瀏覽和安裝外掛。',
  ...
  'hudChrome.plugins.formSummary': '一句話簡介',
  'hudChrome.plugins.formDescription': '描述',
  'hudChrome.plugins.formSource': '外掛原始碼 (JavaScript)',
  'hudChrome.plugins.formNotes': '給審核者的備註',
  'hudChrome.plugins.submitNew': '提交審核',
  'hudChrome.plugins.submitUpdate': '提交更新審核',
  'hudChrome.plugins.newPlugin': '改為建立新外掛',
  'hudChrome.plugins.editPlugin': '更新',
  'hudChrome.plugins.deletePlugin': '下架',
  'hudChrome.plugins.mineTitle': '我的外掛',
  'hudChrome.plugins.statusPending': '等待審核',
  'hudChrome.plugins.statusApproved': '已通過',
  'hudChrome.plugins.statusRejected': '已駁回',
  'hudChrome.plugins.statusListed': '已上架',
  'hudChrome.plugins.statusDelisted': '已下架',
  'hudChrome.plugins.latestLine': '最新提交 v{version}: {status}',
  'hudChrome.plugins.reviewNote': '審核備註: {note}',
  'hudChrome.plugins.submitted': '已提交審核。你可以繼續遊戲, 團隊會盡快查看。',
  'hudChrome.plugins.autoDisabled': '{name} 反覆出錯, 已被關閉。',
