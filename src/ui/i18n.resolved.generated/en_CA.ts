...
export const en_CA: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "bodyWithVersion": "Version {version} of PRIMUS is available. Update now for the latest fixes and improvements.",
      "notNow": "Not now",
      "update": "Update"
    },
    "cameraPrompt": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "The world",
      "intro": "PRIMUS is one continuous land you cross on foot, three zones laid south to north. There is no fast travel, so the journey is part of the adventure.",
      "hub": "Home base",
  ...
  "seo": {
    ...
    "description": "Embark on an epic adventure in PRIMUS, a classic-style micro-MMO playable directly in your browser. Join a persistent shared world, level up classes, and defeat enemies!",
    "genre": "MMORPG",
