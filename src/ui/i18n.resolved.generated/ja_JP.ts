...
export const ja_JP: EnTranslations = {
  ...
  "mode": {
    ...
    "runCta": "キーストーンラン",
    "runAria": "キーストーンラン：最大レベルでコンパニオンパーティーとダンジョンに入ります",
    "runTitle": "キーストーンラン",
    "runDesc": "レベル上げ不要、20分のダンジョン攻略。クラスを選ぶだけで、最大レベル・装備済みで入口に到着し、タンク1人、ヒーラー1人、ダメージ2人がすでに雇われています。",
    "runDungeon": "ダンジョン",
    "runParty": "あなたのパーティー：タンク、ヒーラー、ダメージ、ダメージ。",
    "runStart": "攻略を開始",
  ...
  "playerCard": {
    ...
    "arenaStat": "アリーナ",
    "shareText": "World of ClaudeCraftで伝説を鍛えています: レベル{level} {className}。私のワールドに参加してください:",
