...
export const ko_KR: EnTranslations = {
  ...
  "mode": {
    ...
    "runCta": "쐐기돌 공략",
    "runAria": "쐐기돌 공략: 최고 레벨로 동료 파티와 함께 던전에 입장합니다",
    "runTitle": "쐐기돌 공략",
    "runDesc": "레벨을 올릴 필요 없는 20분짜리 던전 공략입니다. 직업만 고르면 최고 레벨에 장비를 갖춘 채 입구에 도착하며, 방어 전담 1명, 치유 전담 1명, 공격 전담 2명이 이미 고용되어 있습니다.",
    "runDungeon": "던전",
    "runParty": "당신의 파티: 방어 전담, 치유 전담, 공격 전담, 공격 전담.",
    "runStart": "공략 시작",
    "caLabel": "$WOC 계약 주소",
    "caCopyAria": "계약 주소 복사",
