...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "plugins": {
      ...
      "installs": "설치 {count}회",
      "byAuthor": "제작: {author}",
      "byTeam": "World of ClaudeCraft 팀 제작",
      "loading": "플러그인 상점을 불러오는 중...",
      "offline": "온라인 서버에 로그인하면 플러그인을 둘러보고 설치할 수 있습니다.",
      "empty": "아직 등록된 플러그인이 없습니다. 첫 번째로 게시해 보세요.",
      "filteredOut": "검색과 일치하는 플러그인이 없습니다.",
      "installedEmpty": "아직 설치한 플러그인이 없습니다.",
      "developIntro": "플러그인은 클라이언트 측 모드입니다. 모든 제출물은 상점에 표시되기 전에 팀의 검토를 거치며, 업데이트도 다시 검토된 후 플레이어에게 전달됩니다.",
      "docsHint": "API: woc.on(event, handler), 이벤트는 combat, chat, loot, xp, levelup, quest, death, respawn, deed, tick, 그리고 woc.player(), woc.ui.panel(), woc.ui.toast(), woc.ui.sound(), woc.storage 및 woc.util 포매터。",
      "formName": "플러그인 이름",
      "formAuthor": "제작자 이름",
      "formCategory": "카테고리",
      "formSummary": "한 줄 요약",
      "formDescription": "설명",
      "formSource": "플러그인 소스 (JavaScript)",
      "formNotes": "검토자에게 남길 메모",
      "submitNew": "검토 제출",
      "submitUpdate": "업데이트 검토 제출",
      "newPlugin": "대신 새 플러그인 시작",
      "editPlugin": "업데이트",
      "deletePlugin": "내리기",
      "mineTitle": "내 플러그인",
      ...
      "statusListed": "등록됨",
      "statusDelisted": "내려감",
      "latestLine": "최근 제출 v{version}: {status}",
      "reviewNote": "검토 메모: {note}",
      "submitted": "검토를 위해 제출했습니다. 계속 플레이하세요. 팀이 곧 확인합니다.",
      "autoDisabled": "{name}에서 오류가 반복되어 꺼졌습니다."
    }
  },
  "gatherEvent": {
  ...
  "apiError": {
    ...
    "plugins": {
      "invalid_name": "플러그인 이름은 3~40자의 영문, 숫자, 공백, 아포스트로피, 하이픈만 사용할 수 있습니다.",
      "name_not_allowed": "해당 플러그인 이름은 사용할 수 없습니다.",
      "invalid_handle": "제작자 이름은 2~24자의 영문, 숫자, 공백, 아포스트로피, 하이픈만 사용할 수 있습니다.",
      "invalid_summary": "요약은 한 줄, 최대 140자여야 합니다.",
      "invalid_description": "설명이 너무 길거나 지원되지 않는 문자가 포함되어 있습니다.",
      "invalid_category": "목록에 있는 카테고리 중 하나를 선택하세요.",
      "invalid_source": "플러그인 소스가 비어 있습니다.",
      "source_too_large": "플러그인 소스가 너무 큽니다.",
      "source_syntax": "플러그인 소스에 구문 오류가 있습니다.",
      "limit_reached": "이 계정의 플러그인 한도에 도달했습니다.",
      "install_limit": "설치된 플러그인 한도에 도달했습니다.",
      "not_found": "플러그인을 찾을 수 없습니다.",
      "not_listed": "이 플러그인은 현재 이용할 수 없습니다.",
      "not_installed": "이 플러그인은 설치되어 있지 않습니다.",
      "slug_unavailable": "이 플러그인의 링크 이름을 확보하지 못했습니다. 다른 이름을 시도하세요.",
      "review_invalid": "해당 검토 작업은 유효하지 않습니다."
    }
  },
  "guide": {
