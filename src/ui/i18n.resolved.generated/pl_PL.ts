...
export const pl_PL: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "plugins": {
      ...
      "developIntro": "Plugins are client-side mods. Every submission is reviewed by the team before it appears in the store, and updates are reviewed again before they reach players.",
      "docsHint": "API: woc.on(event, handler) with combat, chat, loot, xp, levelup, quest, death, respawn, deed, and tick events, plus woc.player(), woc.ui.panel(), woc.ui.toast(), woc.ui.sound(), woc.storage, and woc.util formatters.",
