...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "plugins": {
      ...
      "hideSource": "Скрыть код",
      "installs": "Установок: {count}",
      "byAuthor": "Автор: {author}",
      "byTeam": "От команды World of ClaudeCraft",
      "loading": "Загрузка магазина плагинов...",
      "offline": "Войдите в онлайн-мир, чтобы просматривать и устанавливать плагины.",
      "empty": "Плагинов пока нет. Станьте первым автором.",
      "filteredOut": "Нет плагинов по вашему запросу.",
      "installedEmpty": "Вы еще не установили ни одного плагина.",
      "developIntro": "Плагины - это клиентские моды. Каждая заявка проходит проверку команды перед публикацией, и обновления проверяются заново, прежде чем попасть к игрокам.",
      "docsHint": "API: woc.on(event, handler) с событиями combat, chat, loot, xp, levelup, quest, death, respawn, deed, tick, плюс woc.player(), woc.ui.panel(), woc.ui.toast(), woc.ui.sound(), woc.storage и форматтеры woc.util.",
      "formName": "Название плагина",
      "formAuthor": "Имя автора",
      "formCategory": "Категория",
      "formSummary": "Краткое описание",
      "formDescription": "Описание",
      "formSource": "Исходный код плагина (JavaScript)",
      "formNotes": "Заметка для проверяющего",
      "submitNew": "Отправить на проверку",
      "submitUpdate": "Отправить обновление на проверку",
      "newPlugin": "Создать новый плагин",
      "editPlugin": "Обновить",
      "deletePlugin": "Снять",
      "mineTitle": "Мои плагины",
      "statusPending": "Ожидает проверки",
      "statusApproved": "Одобрено",
      "statusRejected": "Отклонено",
      "statusListed": "В каталоге",
      "statusDelisted": "Снят с каталога",
      "latestLine": "Последняя заявка v{version}: {status}",
      "reviewNote": "Заметка проверяющего: {note}",
      "submitted": "Отправлено на проверку. Можете продолжать играть, команда скоро посмотрит.",
      "autoDisabled": "{name}: повторные ошибки, плагин отключен."
    }
  },
  "gatherEvent": {
  ...
  "apiError": {
    ...
    "plugins": {
      "invalid_name": "Имя плагина: от 3 до 40 букв, цифр, пробелов, апострофов или дефисов.",
      "name_not_allowed": "Это имя плагина недопустимо.",
      "invalid_handle": "Имя автора: от 2 до 24 букв, цифр, пробелов, апострофов или дефисов.",
      "invalid_summary": "Краткое описание: одна строка длиной до 140 символов.",
      "invalid_description": "Описание слишком длинное или содержит недопустимые символы.",
      "invalid_category": "Выберите одну из перечисленных категорий.",
      "invalid_source": "Исходный код плагина пуст.",
      "source_too_large": "Исходный код плагина слишком большой.",
      "source_syntax": "В исходном коде плагина синтаксическая ошибка.",
      "limit_reached": "Достигнут лимит плагинов для этого аккаунта.",
      "install_limit": "Достигнут лимит установленных плагинов.",
      "not_found": "Плагин не найден.",
      "not_listed": "Этот плагин сейчас недоступен.",
      "not_installed": "Этот плагин не установлен.",
      "slug_unavailable": "Не удалось занять ссылочное имя для плагина. Попробуйте другое название.",
      "review_invalid": "Это действие проверки недопустимо."
    }
  },
  "guide": {
