...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "mangle": {
        "name": "Терзание",
        "description": "Терзает врага, нанося урон оружия плюс $d, дает 10 ярости и много угрозы. Только в форме медведя."
      },
      "thrash": {
        "name": "Буря ударов",
        "description": "Бьет всех врагов рядом на $d урона и вызывает кровотечение, дает 6 ярости. Создает дополнительную угрозу. Только в форме медведя."
      },
      "ironfur": {
        "name": "Железная шкура",
        "description": "Шкура твердеет, повышая броню на $b% на $t сек. Складывается до 4 раз, каждое применение со своей длительностью. Только в форме медведя."
      },
      "maul": {
        "name": "Костолом",
