...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "craftIntro": {
        "weaponcrafting": "Оружейное дело кует топоры, булавы, клинки и посохи в кузнице Иствердья: от медных новичковых образцов до редких ториевых и арканитовых работ.",
        "armorcrafting": "Бронное дело кует кольчужные доспехи в кузнице Иствердья: от клепаной меди до редкой ториевой чешуи.",
        "tailoring": "Портняжное дело ткет ткань для заклинателей и вместительную сумку у станка Иствердья: от домотканых основ до редкого солнечного плетения.",
      ...
      "craftProse": {
        "weaponcrafting": {
          ...
          "ladderBody": "Один полевой рецепт, Eastbrook Arming Sword, известен всем с самого начала и куется где угодно из охотничьих трофеев (пара wolf fangs и bone fragments) плюс шесть Smithing Flux с прилавка forge. Настоящая лестница, это девять рецептов у тренера в трех ступенях, все привязаны к forge: медная ступень (bearded axe, flanged mace, boar spear) учится бесплатно на 0 навыке, железная ступень (longsword, maul, dirk) открывается на 25 навыке по 25 серебра за рецепт, а ториевая ступень (warblade, war axe, battle staff) открывается на 50 навыке по 1 золоту каждый. Darva учит рецепту, как только ваш разряд в ремесле достигает его собственного, так что каждая ступень открывается ровно с началом своей полосы навыка.\n\nЕще один рецепт едет с парой: Gravewyrm Gauntlets, комбинированная вещь от тренера, над которой может работать только настроенный Smith с Weaponcrafting и Armorcrafting на 25 навыке, и станок ей вовсе не нужен.",
      ...
      "ench": {
        ...
        "disenchantNote": "Распыление дробит ненужное оружие или доспех в чародейные материалы согласно качеству.",
        ...
        "enchantsNote": "Каждые чары, их слот, реагенты и точный бонус; только рунная ступень расходует типовые побочные материалы.",
        "colEnchant": "Чары",
        "colSlot": "Слот",
        "colTier": "Ступень",
        "colBonus": "Бонус",
      ...
      "gatherIntro": {
        "mining": "Горное дело добывает руду из жил во всех трех зонах, кормит кузнечные ремесла и ограничено 100.",
        "logging": "Лесозаготовка валит лес во всех трех зонах, идет на древки и инструменты и ограничена 100.",
        "herbalism": "Травничество собирает травы во всех трех зонах, кормит алхимию и кулинарию и ограничено 100.",
      ...
      "gatherDeeds": {
        ...
        "fishing": "Рубеж в 100 вписывает Old Salt, а 200 вписывает Master Angler с его титулом, самую вершину искусства рыбака; Fishing также засчитывается в Master Gatherer, зарабатываемый при 100 в любых трех собирательских ремеслах. Первая рыба из вод каждой зоны заполняет свою страницу, а Glimmerfin Koi записывает Glimmer of Hope, так что путники с удочкой в котомке заполняют книгу быстрее, чем ожидают."
      },
      "fish": {
        "startHeading": "С чего начать",
