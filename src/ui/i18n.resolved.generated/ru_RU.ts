...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "offlineSave": {
      "saved": "Персонаж сохранён.",
      "failed": "Не удалось сохранить персонажа. Браузер отклонил запись.",
      "blocked": "Сохранение не выполнено: ячейку офлайн-сохранения занимает другой персонаж.",
      "unavailable": "Сохранение не выполнено: в этом браузере нет хранилища для офлайн-персонажа."
    },
    "readyCheck": {
    ...
    "options": {
      ...
      "shiftMode": "Тихий режим (без звука, лимит FPS)",
  ...
  "mode": {
    ...
    "runCta": "Ключевой забег",
    "runAria": "Ключевой забег: вход в подземелье на максимальном уровне с отрядом спутников",
    "runTitle": "Ключевой забег",
    "runDesc": "Двадцатиминутный забег по подземелью без прокачки. Выберите класс и окажитесь у входа на максимальном уровне, в снаряжении, уже наняв танка, лекаря и двух бойцов.",
    "runDungeon": "Подземелье",
    "runParty": "Ваш отряд: танк, лекарь, боец, боец.",
    "runStart": "Начать забег",
  ...
  "auth": {
    ...
    "offlineSave": {
      "continueHint": "Здесь сохранён: {name}, {cls} {level} уровня. Нажмите «Войти в мир», чтобы продолжить.",
      "replaceWarning": "Это заменит сохранённого персонажа {name}, {cls} {level} уровня, и отменить это будет нельзя. Нажмите «Войти в мир» ещё раз для подтверждения."
    },
    "create": "Создать",
  ...
  "playerCard": {
    ...
    "arenaStat": "Арена",
    "shareText": "Я создаю свою легенду в World of ClaudeCraft: уровень {level}, {className}. Присоединяйтесь к моему миру:",
  ...
  "entities": {
    "abilities": {
      ...
      "mangle": {
        "name": "Терзание",
        "description": "Терзает врага, нанося урон оружия плюс {damage}, дает 10 ярости и много угрозы. Только в форме медведя."
      },
      "thrash": {
        "name": "Буря ударов",
        "description": "Бьет всех врагов рядом на {damage} урона и вызывает кровотечение, дает 6 ярости. Создает дополнительную угрозу. Только в форме медведя."
      },
      "ironfur": {
        "name": "Железная шкура",
        "description": "Шкура твердеет, повышая броню на {buff}% на {duration} сек. Складывается до 4 раз, каждое применение со своей длительностью. Только в форме медведя."
      },
      "maul": {
        "name": "Костолом",
      ...
      "fire_ward": {
        "name": "Углевой оберег",
        "description": "Окутывает вас углями, поглощая {damage} урона в течение 30 сек."
      },
      "remove_lesser_curse": {
        "name": "Слом порчи",
        "description": "Снимает один вредоносный магический эффект с союзной цели."
      },
      "mana_shield": {
        "name": "Эфирный страж",
        "description": "Стягивает вокруг вас чистый эфир, поглощая {damage} урона в течение 60 сек."
      },
      "resurrection": {
        "name": "Обряд возврата",
        "description": "Призывает павшего союзника обратно к жизни у его тела с 60% здоровья и маны. Нельзя применить в бою."
      },
      "inner_fire": {
        "name": "Пламя веры",
        "description": "Окутывает вас священным пламенем, повышая броню на {buff} на 10 мин."
      },
      "holy_fire": {
        "name": "Возжженный гнев",
        "description": "Охватывает цель священным пламенем, нанося {damage} урона и еще {overTime} за 10 сек."
      },
      "dispel_magic": {
        "name": "Слово освобождения",
        "description": "Произносит слово освобождения: снимает 2 вредоносных магических эффекта с союзника или 2 полезных с врага."
      },
      "devouring_plague": {
        "name": "Иссушающая порча",
        "description": "Иссушающая порча терзает цель, нанося {damage} урона от темной магии за 24 сек и исцеляя вас на нанесенный урон."
      },
      "purge": {
        "name": "Ветроочищение",
        "description": "Смывает с врага один полезный магический эффект."
      },
      "ancestral_spirit": {
        "name": "Зов предков",
        "description": "Предки зовут павшего союзника обратно к его телу с 60% здоровья и маны. Нельзя применить в бою."
      },
      "windfury_weapon": {
        "name": "Клеймо шквала",
        "description": "Наделяет оружие воющим ветром: каждый удар наносит дополнительно {damage} урона от сил природы в течение 5 мин."
      },
      "fire_nova": {
        "name": "Взрыв углей",
        "description": "Вокруг вас вспыхивает пламя, опаляя всех врагов рядом на {damage} урона от огня."
      },
      "lesser_healing_wave": {
        "name": "Быстрые воды",
        "description": "Быстрый поток воды исцеляет союзную цель на {damage}."
      },
      "redemption": {
        "name": "Обряд рассвета",
        "description": "Поднимает павшего союзника к его телу с 60% здоровья и маны. Нельзя применить в бою."
      },
      "blessing_of_wisdom": {
        "name": "Клятва прозрения",
        "description": "Благословляет отряд, восстанавливая всем его членам {buff} ресурса при каждом тике восстановления в течение 30 мин."
      },
      "seal_of_the_crusader": {
        "name": "Клеймо рвения",
        "description": "Наполняет вас рвением на 30 сек: каждый удар в ближнем бою наносит дополнительно {damage} урона от светлой магии, а вызванный им Приговор бьет куда тяжелее, чем Клеймо клятвы."
      },
      "hunters_mark": {
        "name": "Метка добычи",
        "description": "Отмечает цель как вашу добычу, повышая весь получаемый ею урон на 5% на 2 мин."
      },
      "immolation_trap": {
        "name": "Тлеющая ловушка",
        "description": "Расставляет на земле тлеющую ловушку, обжигая находящихся в ней врагов на {damage} урона от огня каждые 2 сек в течение 12 сек."
      },
      "bear_charge": {
        "name": "Натиск бурого",
