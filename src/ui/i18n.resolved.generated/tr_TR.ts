...
export const tr_TR: EnTranslations = {
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "brain_freeze": "Donma oklarınız bazen bir sonraki Kış Kırbacı'nı anında kullanılır hale getirir ve bekleme süresini atlar.",
  ...
  "playerCard": {
    ...
    "arenaStat": "Arena",
    "shareText": "World of ClaudeCraft'ta efsanemi yaratıyorum: Seviye {level} {className}. Dünyama katıl:",
