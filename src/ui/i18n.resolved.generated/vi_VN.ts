...
export const vi_VN: EnTranslations = {
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "brain_freeze": "Các tia sương giá của bạn đôi khi khiến Roi Mùa Đông kế tiếp trở thành phép tức thì và bỏ qua thời gian hồi chiêu.",
  ...
  "playerCard": {
    ...
    "shareText": "Tôi đang rèn nên huyền thoại của mình trong World of ClaudeCraft: {className} cấp {level}. Hãy tham gia thế giới của tôi:",
