...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "plugins": {
      ...
      "installs": "{count} 次安装",
      "byAuthor": "作者: {author}",
      "byTeam": "由 World of ClaudeCraft 团队制作",
      "loading": "正在加载插件商店...",
      "offline": "登录在线服务器后即可浏览和安装插件。",
      "empty": "还没有已上架的插件。来发布第一个吧。",
      "filteredOut": "没有符合搜索条件的插件。",
      "installedEmpty": "你还没有安装任何插件。",
      "developIntro": "插件是客户端模组。每次提交都会先经团队审核才会出现在商店中, 更新也会再次审核后才推送给玩家。",
      ...
      "reviewNote": "审核备注: {note}",
      "submitted": "已提交审核。你可以继续游戏, 团队会尽快查看。",
      "autoDisabled": "{name} 反复出错, 已被关闭。"
    }
  },
  "gatherEvent": {
  ...
  "apiError": {
    ...
    "plugins": {
      "invalid_name": "插件名称需为3到40个字母、数字、空格、撇号或连字符。",
      "name_not_allowed": "该插件名称不被允许。",
      "invalid_handle": "作者名需为2到24个字母、数字、空格、撇号或连字符。",
      "invalid_summary": "简介必须为一行, 最多140个字符。",
      "invalid_description": "描述过长或包含不支持的字符。",
      "invalid_category": "请选择列出的分类之一。",
      "invalid_source": "插件源码为空。",
      "source_too_large": "插件源码过大。",
      "source_syntax": "插件源码存在语法错误。",
      "limit_reached": "该账号的插件数量已达上限。",
      "install_limit": "已安装插件数量已达上限。",
      "not_found": "未找到插件。",
      "not_listed": "该插件当前不可用。",
      "not_installed": "该插件尚未安装。",
      "slug_unavailable": "无法为该插件保留链接名。请尝试其他名称。",
      "review_invalid": "该审核操作无效。"
    }
  },
  "guide": {
