...
export const zh_TW: EnTranslations = {
  ...
  "mode": {
    ...
    "runCta": "基石副本",
    "runAria": "基石副本：以滿級角色帶領隨從小隊進入地城",
    "runTitle": "基石副本",
    "runDesc": "一場二十分鐘的地城挑戰，無需升級。選擇一個職業，直接以滿級、帶齊裝備抵達門口，並已雇好一名坦克、一名補師和兩名輸出。",
    "runDungeon": "地城",
    "runParty": "你的小隊：坦克、補師、輸出、輸出。",
    "runStart": "開始挑戰",
    "caLabel": "$WOC 合約地址",
    "caCopyAria": "複製合約地址",
  ...
  "playerCard": {
    ...
    "arenaStat": "競技場",
    "shareText": "我正在 World of ClaudeCraft 中鑄就傳說：{level}級 {className}。加入我的世界：",
