...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "plugins": {
      ...
      "installs": "{count} 次安裝",
      "byAuthor": "作者: {author}",
      "byTeam": "由 World of ClaudeCraft 團隊製作",
      "loading": "正在載入外掛商店...",
      "offline": "登入線上伺服器後即可瀏覽和安裝外掛。",
      "empty": "還沒有已上架的外掛。來發布第一個吧。",
      "filteredOut": "沒有符合搜尋條件的外掛。",
      "installedEmpty": "你還沒有安裝任何外掛。",
      "developIntro": "外掛是客戶端模組。每次提交都會先經團隊審核才會出現在商店中, 更新也會再次審核後才推送給玩家。",
      "docsHint": "API: woc.on(event, handler), 事件包括 combat, chat, loot, xp, levelup, quest, death, respawn, deed, tick, 另有 woc.player(), woc.ui.panel(), woc.ui.toast(), woc.ui.sound(), woc.storage 和 woc.util 格式化工具。",
      "formName": "外掛名稱",
      "formAuthor": "作者名",
      "formCategory": "分類",
      "formSummary": "一句話簡介",
      "formDescription": "描述",
      "formSource": "外掛原始碼 (JavaScript)",
      "formNotes": "給審核者的備註",
      "submitNew": "提交審核",
      "submitUpdate": "提交更新審核",
      "newPlugin": "改為建立新外掛",
      ...
      "statusListed": "已上架",
      "statusDelisted": "已下架",
      "latestLine": "最新提交 v{version}: {status}",
      "reviewNote": "審核備註: {note}",
      "submitted": "已提交審核。你可以繼續遊戲, 團隊會盡快查看。",
      "autoDisabled": "{name} 反覆出錯, 已被關閉。"
    }
  },
  "gatherEvent": {
  ...
  "apiError": {
    ...
    "plugins": {
      "invalid_name": "外掛名稱需為3到40個字母、數字、空格、撇號或連字號。",
      "name_not_allowed": "該外掛名稱不被允許。",
      "invalid_handle": "作者名需為2到24個字母、數字、空格、撇號或連字號。",
      "invalid_summary": "簡介必須為一行, 最多140個字元。",
      "invalid_description": "描述過長或包含不支援的字元。",
      "invalid_category": "請選擇列出的分類之一。",
      "invalid_source": "外掛原始碼為空。",
      "source_too_large": "外掛原始碼過大。",
      "source_syntax": "外掛原始碼有語法錯誤。",
      "limit_reached": "此帳號的外掛數量已達上限。",
      "install_limit": "已安裝外掛數量已達上限。",
      "not_found": "找不到外掛。",
      "not_listed": "該外掛目前不可用。",
      "not_installed": "該外掛尚未安裝。",
      "slug_unavailable": "無法為該外掛保留連結名稱。請嘗試其他名稱。",
      "review_invalid": "該審核操作無效。"
    }
  },
  "guide": {
