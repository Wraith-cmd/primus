...
describe('client HTML shell', () => {
  ...
  it('excludes download and site-copy surfaces from native and Steam builds while allowing website desktop', () => {
  ...
  it('lays out mobile More tray buttons horizontally', () => {
    ...
    // The Book of Deeds and Crafting ride the More grid in BOTH entries
