...
describe('draw_stats_core', () => {
  ...
  it('adds solver passes only when live counters reset them away', () => {
    expect(drawStatWithManualPasses(400, 2, 1, false)).toBe(402);
    expect(drawStatWithManualPasses(300_000, 2, 2, false)).toBe(300_004);
    expect(drawStatWithManualPasses(400, 2, 1, true)).toBe(400);
    expect(drawStatWithManualPasses(300_000, 2, 2, true)).toBe(300_000);
  });
